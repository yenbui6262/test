    ...
    class Mchitietsinhvien extends MY_Model
    {
        ...
        public function getthongtincb($matk)
        {
            ...
            $this->db->group_by("tk.PK_sMaTK")
                     ->select("lop.sTenLop,tk.PK_sMaTK,tk.sHoTen,tk.dNgaySinh,tk.sChucvu,tk.iGioiTinh,tk.sTenTK,tk.FK_sMaQuyen,hs.tChiTietTT,hs.tChiTietHT,t.sTenT as tinhht,h.sTenH as huyenht,x.sTenX as xaht,tt.sTenT as tinhtt,hh.sTenH as huyentt,xx.sTenX as xatt,u.tMoTa")
