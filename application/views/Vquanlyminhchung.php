...
<div class="container-fluid">
    <div class="panel panel-default">
            <div class="panel-heading text-left">
                <h4 style="color: #fff;" class="text-center m-0">{if !empty($tenct)}{$tenct}{/if}</h4>
            </div>
                        ...
                        {if !empty($params['minhchung'])}
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{$val.tLink}" class="btn btn-info"><i class="fas fa-eye" title="Thông tin chi tiết"></i></a>
