        ...
        <div class="card-body">
           <div class="row">
                ...
                <div class="form-group col-xl-2 text-center" style="margin-top:30px">
                    <button type="submit" class="btn btn-secondary" name="minhchung[type]" value="search" id="search"><i class="fa fa-search" aria-hidden="true"></i>&nbsp;Tìm kiếm</button>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover table-bordered">
                    ...
                    {/foreach}
                    {else}
                        <tr class="text-center"><td colspan="6">Chưa có dữ liệu</td> </tr>
                    {/if}
                    </tbody>
                </table>
            </div>
