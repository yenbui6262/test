...
<div class="container">
    <div class="card">
        ...
        <br>
        <div class="card-body">
            <form action="{$url}ds_minhchung" method="POST" class="insert" id="myForm">
                <div class="row">
                    ...
                    <div class="col-md-3 input-group input-group-sm mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon1">Bắt đầu từ:</span>
                        </div>
                    ...
                    <div class="col-md-10 input-group input-group-sm mb-3">
                        <div class="input-group-prepend">
