                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <button data-id="{$k}" data-update="{$val.sMaDS}" class="btn btn-sm btn-danger  check b1" type="submit" title="Xác nhận không tham gia" {if ($val.dThoiGianXN < $date)}disabled{/if}><i class="fas fa-user-slash"></i></button>
                                {else}
                                <button data-id="{$k}" data-update="{$val.sMaDS}"class="btn btn-sm btn-success check b1" type="submit" title="Xác nhận tham gia"{if ($val.dThoiGianXN< $date)}disabled{/if} ><i class="fas fa-user-check"></i></button>
