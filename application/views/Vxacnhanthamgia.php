                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            {if ($val.dThoiGianXN >= $date)}
                                ...
                                <button data-id="{$k}" data-update="{$val.sMaDS}" class="btn btn-sm btn-danger  check a1 b1" type="submit" title="Xác nhận không tham gia" {if ($val.dThoiGianXN < $date)}disabled{/if}><i class="fas fa-user-slash"></i></button>
                                {else}
