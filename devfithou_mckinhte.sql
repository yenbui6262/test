...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 21, 2021 at 12:47 PM
...
CREATE TABLE IF NOT EXISTS `hs_dm_hanhchinh` (
  `PK_sMaHanhChinh` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `sTenHanhChinh` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `tMota` text COLLATE utf8_unicode_ci,
  `maudon` text COLLATE utf8_unicode_ci
...
('1629511391887', 'Đơn xin phúc khảo bài thi', 'Lập đơn xin phúc khảo bài thi', 'phuckhaobaithi\n'),
('162951140530', 'Đơn miễn giảm học phí', 'Lập đơn miễn giảm học phí', 'miengiamhocphi\n'),
('1629511466221', 'Thủ tục xác nhận sinh viên Đăng ký vé tháng xe Buýt', 'Lấy xác nhận sinh viên Đăng ký vé tháng xe Buýt', 'vethangxebuyt\n'),
('1629511610282', 'Đơn xin thôi học', 'Lập đơn xin thôi học', 'thoihoc\n'),
('1629511629808', 'Đơn xin học tiếp ', 'Lập đơn xin học tiếp', 'hoctiep\n'),
('1629511642434', 'Giấy xác nhận làm lại thẻ SV &ATM ', 'Xin xác nhận làm lại thẻ SV &ATM ', 'caplaiATM\n'),
('1629511658295', 'Giấy xác nhận sinh viên', 'Xin giấy xác nhận sinh viên', 'xacnhanSV\n'),
('1629511668350', 'Thủ tục xin cấp lại Chứng chỉ Giáo dục quốc phòng và an ninh', 'Thủ tục xin cấp lại Chứng chỉ Giáo dục quốc phòng và an ninh', 'chungchiGDQP\n'),
('1629511675270', 'Đơn xin kiểm tra điểm', 'Sinh viên, học viên chưa có điểm hoặc đề nghị xem lại kết quả thi học phần', 'kiemtradiem\n'),
('162951168316', 'Đơn đăng ký tốt nghiệp', 'Đơn đăng ký tốt nghiệp (Nộp 2 bản)', 'dangkytotnghiep\n'),
('1629511688207', 'Giấy cam đoan đã hoàn thành các chương trình đào tạo', 'Giấy cam đoan đã hoàn thành các chương trình đào tạo', 'camdoanhoanthanhCTDT\n'),
('1629512072225', 'Đơn xác nhận nhân sự', 'Đơn xác nhận nhân sự (xác nhận của công an nơi cư trú)', 'xacnhandansu\n');
...
CREATE TABLE IF NOT EXISTS `hs_dm_uutien` (
  `PK_sMaNhom` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `hs_tbl_chuongtrinh` (
  `PK_sMaChuongTrinh` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `sTenCT` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `tMota` text COLLATE utf8_unicode_ci,
  `FK_sMaCB` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `hs_tbl_dangkydon` (
  `PK_sMaDangKy` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `FK_sMaSV` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `FK_sMaCanbo` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `FK_sMaHanhChinh` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `dTGThem` datetime NOT NULL,
  `dTGDuyet` datetime DEFAULT NULL,
  `iTrangThai` int(5) NOT NULL,
  `tLydo` text COLLATE utf8_unicode_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `hs_tbl_hososv` (
  `PK_sMaHoSo` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `FK_sMaTK` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `tChiTietTT` text COLLATE utf8_unicode_ci,
  `tChiTietHT` text COLLATE utf8_unicode_ci,
  `FK_sUuTien` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `sSDT` varchar(12) COLLATE utf8_unicode_ci DEFAULT NULL,
  `sSTK` varchar(13) COLLATE utf8_unicode_ci DEFAULT NULL,
  `sChiNhanh` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `hs_tbl_hososv`
--

INSERT INTO `hs_tbl_hososv` (`PK_sMaHoSo`, `FK_sMaTK`, `FK_sMaTinhTT`, `FK_sMaHuyenTT`, `FK_sMaXaTT`, `FK_sMaTinhHT`, `FK_sMaHuyenHT`, `FK_sMaXaHT`, `tChiTietTT`, `tChiTietHT`, `FK_sUuTien`, `sSDT`, `sSTK`, `sChiNhanh`) VALUES
('162952086619A47010001', '19A47010001', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0982513650', '0301000423956', 'Hoàn Kiếm'),
('162952086619A47010002', '19A47010002', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0362992899', '0301000423955', 'Hoàn Kiếm'),
('162952086619A47010004', '19A47010004', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0358292698', '0301000423954', 'Hoàn Kiếm'),
('162952086619A47010006', '19A47010006', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0385436862', '0301000423950', 'Hoàn Kiếm'),
('162952086619A47010007', '19A47010007', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0335756277', '0301000423951', 'Hoàn Kiếm'),
('162952086619a47010008', '19a47010008', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0393644209', '0301000423961', 'Hoàn Kiếm'),
('162952086619A47010009', '19A47010009', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0377614812', '0301000423962', 'Hoàn Kiếm'),
('162952086619A47010011', '19A47010011', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0763048664', '0301000423960', 'Hoàn Kiếm'),
('162952086619A47010012', '19A47010012', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0987486755', '0361000340275', 'Hoàn Kiếm'),
('162952086619A47010014', '19A47010014', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0763048664', '0301000423960', 'Hoàn Kiếm'),
('162952086619A47010015', '19A47010015', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0963305146', '0301000423972', 'Hoàn Kiếm'),
('162952086619a47010016', '19a47010016', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0963774825', '0301000423977', 'Hoàn Kiếm'),
('162952086619A47010017', '19A47010017', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0942911558', '0301000423979', 'Hoàn Kiếm '),
('162952086619A47010018', '19A47010018', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0865445301', '0301000423970', 'Hoàn Kiếm'),
('162952086619A47010019', '19A47010019', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0946693672', '1021000020551', 'Dân Tiến Khoái Châu'),
('162952086619A47010020', '19A47010020', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0343092681', '0301000423969', 'Hoàn Kiếm'),
('162952086619A47010021', '19A47010021', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0989432496', '0301000423966', 'Hoàn Kiếm'),
('162952086619a47010023', '19a47010023', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0867574622', '0301000423973', 'Hoàn kiếm'),
('162952086719A47010026', '19A47010026', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0384508141', '0361000353698', 'Hoàn Kiếm'),
('162952086719A47010029', '19A47010029', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0865981744', '0301000423981', 'Hoàn Kiếm'),
('162952086719A47010031', '19A47010031', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0379883820', '0301000423980', 'Hoàn Kiếm'),
('162952086719A47010032', '19A47010032', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0382858868', '0301000423994', 'Hoàn Kiếm'),
('162952086719A47010035', '19A47010035', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0978914642', '0301000423989', 'Hoàn Kiếm'),
('162952086719A47010036', '19A47010036', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0378158262', '0301000423986', 'Hoàn Kiếm'),
('162952086719A47010037', '19A47010037', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0982483869', '0301000423983', 'Hoàn Kiếm'),
('162952086719A47010038', '19A47010038', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0982936035', '0301000423990', 'Hoàn Kiếm'),
('162952086719a47010039', '19a47010039', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0981923074', '0301000423992', 'Hoàn Kiếm'),
('162952086719A47010040', '19A47010040', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0399735845', '0301000423991', 'Hoàn Kiếm'),
('162952086719A47010041', '19A47010041', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0963123850', '0301000424004', 'Hoàn Kiếm'),
('162952086719A47010042', '19A47010042', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0964535460', '0301000424000', 'Hoàn Kiếm'),
('162952086719a47010043', '19a47010043', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0969958937', '0301000424002', 'Hoàn Kiếm'),
('162952086719A47010044', '19A47010044', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0393559783', '0303010004239', 'Hoàn Kiếm'),
('162952086719A47010045', '19A47010045', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0862102150', '0301000423997', 'Hoàn Kiếm'),
('162952086719A47010046', '19A47010046', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0396983112', '0301000423995', 'Hoàn Kiếm'),
('162952086719A47010048', '19A47010048', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0354490876', '0301000424033', 'Hoàn Kiếm'),
('162952086719A47010049', '19A47010049', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0946262864', '0301000424008', 'Hoàn Kiếm'),
('162952086719A47010051', '19A47010051', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0345919806', '0301000424029', 'Hoàn Kiếm'),
('162952086719A47010052', '19A47010052', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0962954624', '0301000424006', 'Hoàn Kiếm'),
('162952086719A47010055', '19A47010055', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0968733207', '0301000424034', 'Hoàn Kiếm'),
('162952086719A47010057', '19A47010057', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0886402899', '0301000423948', 'Hoàn Kiếm'),
('162952086719A47010058', '19A47010058', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0389181162', '0301000424037', 'Hoàn Kiếm'),
('162952086819A47010059', '19A47010059', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0816683386', '0301000424036', 'Hoàn Kiếm'),
('162952086819A47010060', '19A47010060', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0397748104', '0301000424039', 'Hoàn Kiếm'),
('162952086819A47010063', '19A47010063', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0386994228', '0301000424042', 'Hoàn Kiếm'),
('162952086819A47010064', '19A47010064', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0354054086', '0301000424043', 'Hoàn Kiếm'),
('162952086819A47010065', '19A47010065', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0344682082', '0301000424022', 'Hoàn Kiếm'),
('162952086819A47010066', '19A47010066', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0968025642', '0301000425487', 'Hoàn Kiếm'),
('162952086819A47010067', '19A47010067', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0365103535', '0301000424026', 'Kim Đồng'),
('162952086819A47010069', '19A47010069', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0398222617', '0301000424028', 'Hoàn Kiếm'),
('162952086819A47010070', '19A47010070', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0981527592', '0301000424027', 'Hoàn Kiếm'),
('162952086819A47010071', '19A47010071', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0335534254', '0301000424030', 'Hoàn Kiếm'),
('162952086819A47010072', '19A47010072', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0339121927', '0301000424527', 'Hoàn Kiếm'),
('162952086819A47010073', '19A47010073', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0928364265', '0301000424023', 'Hoàn Kiếm'),
('162952086819A47010074', '19A47010074', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0342917473', '0301000424024', 'Hoàn kiếm'),
('162952086819A47010075', '19A47010075', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0374016877', '0301000424014', 'Hoàn Kiếm'),
('162952086819A47010076', '19A47010076', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0975405148', '0301000424016', 'Hoàn Kiếm'),
('162952086819A47010077', '19A47010077', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0326579406', '0301000424020', 'Hoàn Kiếm');
...
CREATE TABLE IF NOT EXISTS `hs_tbl_lienhe` (
  `PK_sMaDS` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `FK_sMaHoSo` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `hs_tbl_lop` (
  `PK_sMaLop` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `sTenLop` varchar(50) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `hs_tbl_lop`
--

INSERT INTO `hs_tbl_lop` (`PK_sMaLop`, `sTenLop`) VALUES
('K28 TMĐT', 'K28 TMĐT');
...
CREATE TABLE IF NOT EXISTS `hs_tbl_minhchung` (
  `PK_sMaMC` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `FK_sMaSV` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `FK_sMaCT` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `tLink` text COLLATE utf8_unicode_ci NOT NULL,
  `FK_sMaCB` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `dTGDuyet` datetime DEFAULT NULL,
  `iTrangThai` int(11) DEFAULT NULL,
  `FK_sMaCBCD` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `hs_tbl_quyen` (
  `PK_sMaQuyen` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `hs_tbl_taikhoan` (
  `PK_sMaTK` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `sTenTK` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `sMatKhau` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `FK_sMaQuyen` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `sHoTen` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `sFK_Lop` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `iGioiTinh` int(5) DEFAULT NULL,
  `dNgaySinh` date DEFAULT NULL,
  `tEmail` text COLLATE utf8_unicode_ci,
  `sChucvu` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
('19A47010001', '19A47010001', '11abf6367ac1841af851e46858d413e4b87bbf79', '2', 'Nguyễn Thị Yến', 'K28 TMĐT', 2, '2002-04-01', NULL, NULL),
('19A47010002', '19A47010002', '3c94ea1379c7acca8e82ff4b84ed68d63558294c', '2', 'Phùng Thị Huyền Anh', 'K28 TMĐT', 2, '2001-10-04', NULL, NULL),
('19A47010004', '19A47010004', '11de3a522f7a231c889af890ab11be17ae979dfa', '2', 'Nguyễn Thị Phương', 'K28 TMĐT', 2, '2001-12-03', NULL, NULL),
('19A47010006', '19A47010006', '87a8235477cf350b828cd7b8287e6bcfdb104ee1', '2', 'Đinh Thị Phương Thảo', 'K28 TMĐT', 2, '2001-06-11', NULL, NULL),
('19A47010007', '19A47010007', '16c954b51ff71a690e682f17bcab64eafd7501f7', '2', 'Bùi Thị Linh', 'K28 TMĐT', 2, '2001-01-09', NULL, NULL),
('19a47010008', '19a47010008', '937ec58774f4b18acc4b0428e89253099f2dd3e7', '2', 'Đoàn Thị Phương', 'K28 TMĐT', 2, '2002-12-12', NULL, NULL),
('19A47010009', '19A47010009', 'cf5a52f9a4a219eb7675d0950e7300cd2cb261a6', '2', 'Nguyễn Thị Bích Loan', 'K28 TMĐT', 2, '2001-12-08', NULL, NULL),
('19A47010011', '19A47010011', '8e8868a643c6ceea2d490ac4c35ed9b8b472d0bd', '2', 'Vũ Thị Nhung', 'K28 TMĐT', 2, '2001-10-12', NULL, NULL),
('19A47010012', '19A47010012', '2661a2f52799f86beecfbd457096936550cfcf34', '2', 'Nguyễn Minh Ngọc', 'K28 TMĐT', 2, '2003-05-01', NULL, NULL),
('19A47010014', '19A47010014', '96e66eb8b728496642c7cd79d3249d58ecd76a93', '2', 'Vũ Thị Nhung', 'K28 TMĐT', 2, '2001-10-12', NULL, NULL),
('19A47010015', '19A47010015', 'b0eb1beaf146359a1acb29c70134bc2c6fb1b408', '2', 'Bùi Thị Bích', 'K28 TMĐT', 2, '2002-01-06', NULL, NULL),
('19a47010016', '19a47010016', '433ed696b980b49a7c455360ff91a243af5bb78f', '2', 'Kiều Thị Bích Phương', 'K28 TMĐT', 2, '2003-03-06', NULL, NULL),
('19A47010017', '19A47010017', 'd3f1bb1b06a3e9a5f1386b614bc1e4b672c07d8b', '2', 'Nguyễn Thanh Hồng ', 'K28 TMĐT', 2, '2003-01-03', NULL, NULL),
('19A47010018', '19A47010018', 'cbc12069c800f720b000abc5c52d21a3314ca93c', '2', 'Nguyễn Thị Huyền Trang', 'K28 TMĐT', 2, '2001-05-09', NULL, NULL),
('19A47010019', '19A47010019', 'ce490e3f94a112404f2f3e3b9f76738ae232fc33', '2', 'Phạm Thuỳ Dương', 'K28 TMĐT', 2, '2001-01-11', NULL, NULL),
('19A47010020', '19A47010020', 'c64a61a08ff7fc249f8e5accf5404a0a542e476c', '2', 'Nguyễn Thị Thúy Phương', 'K28 TMĐT', 2, '2003-05-05', NULL, NULL),
('19A47010021', '19A47010021', '3dcd3a8ea23c07614354047ec59cc8b90d0d449b', '2', 'Nguyễn Danh Thúy Hằng', 'K28 TMĐT', 2, '2003-05-09', NULL, NULL),
('19a47010023', '19a47010023', 'a6e2a5e6df6e5af7b41d8870339d678227cd0d93', '2', 'Nguyễn thị ánh hồng', 'K28 TMĐT', 2, '2002-06-02', NULL, NULL),
('19A47010026', '19A47010026', '05e3dded4e59cd290ff39bd8371fc1048c85147a', '2', 'Nguyễn Hồng Phương', 'K28 TMĐT', 1, '2001-09-04', NULL, NULL),
('19A47010029', '19A47010029', 'f7baf183f17e7725b858f976e100cefebb1691a3', '2', 'Nguyễn Thùy Dương', 'K28 TMĐT', 2, '2001-02-12', NULL, NULL),
('19A47010031', '19A47010031', 'd6ad2e0748e881cefb559825f5b8ba775219e72a', '2', 'Trần Văn Minh', 'K28 TMĐT', 1, '2001-03-02', NULL, NULL),
('19A47010032', '19A47010032', 'c056708c9f793dff9486ac3596f0b2abe869572e', '2', 'Bạch Thị Chiến', 'K28 TMĐT', 2, '2003-06-01', NULL, NULL),
('19A47010035', '19A47010035', 'cc0d9b93e785df835514b379d5d8fe99ab047e3b', '2', 'Trần Thị Thảo', 'K28 TMĐT', 2, '2003-04-01', NULL, NULL),
('19A47010036', '19A47010036', '0498ee5b3136e95577c2c836b405784561552b64', '2', 'Phạm Thị Tuyết Mai', 'K28 TMĐT', 2, '2001-02-06', NULL, NULL),
('19A47010037', '19A47010037', '729990fc2a89bffdf5ca5d239f2c6815375bb6ac', '2', 'Bùi Hiền Lương', 'K28 TMĐT', 2, '2002-12-04', NULL, NULL),
('19A47010038', '19A47010038', '56b7a53d24e5916cd45fa95620e44deb42e5c39a', '2', 'Nguyễn Hồng Diệu', 'K28 TMĐT', 2, '2003-01-10', NULL, NULL),
('19a47010039', '19a47010039', '533c1ff4716c8bc58cc65a3a4025bad483108ce2', '2', 'Nông Long Nhật', 'K28 TMĐT', 1, '2002-06-02', NULL, NULL),
('19A47010040', '19A47010040', '855421e79793de3f68d5dd69544290e0b050fe18', '2', 'Bùi Trung Hiếu', 'K28 TMĐT', 1, '2002-04-10', NULL, NULL),
('19A47010041', '19A47010041', '991f1800798dc1c4f6779ba83ac3daff2a256e46', '2', 'Nguyễn Thị Anh Tuyến', 'K28 TMĐT', 2, '2002-09-02', NULL, NULL),
('19A47010042', '19A47010042', '0c1657ca075d059bb6ec86425e0f3d1d3a4abe8f', '2', 'Phạm Văn Dân', 'K28 TMĐT', 1, '2002-01-03', NULL, NULL),
('19a47010043', '19a47010043', '33c1b9d487b1c78a057d1d09633b12049898110d', '2', 'Chu Thị Trà My', 'K28 TMĐT', 2, '2002-01-05', NULL, NULL),
('19A47010044', '19A47010044', 'c71adc8f2793f2a9dc02cabe3ce754cf31fc9bd3', '2', 'Phạm Khánh Huyền', 'K28 TMĐT', 2, '2002-11-06', NULL, NULL),
('19A47010045', '19A47010045', '4ea80b5c56cba6e17d170e0fae1f858f5462cc66', '2', 'Nguyễn Thanh Linh', 'K28 TMĐT', 2, '2002-03-11', NULL, NULL),
('19A47010046', '19A47010046', '12a853a3443135001e5248ad9afbf824756030a8', '2', 'Phùng Thị Xuân Nhi', 'K28 TMĐT', 2, '2002-12-01', NULL, NULL),
('19A47010048', '19A47010048', '893abb45356e641650088d6fb885e2bd79dbb587', '2', 'Nguyễn Thị Hảo', 'K28 TMĐT', 2, '2002-01-10', NULL, NULL),
('19A47010049', '19A47010049', '68169e54bc118d99c474c418c354f549c9f32dab', '2', 'Trương Trọng Nhân', 'K28 TMĐT', 1, '2001-02-11', NULL, NULL),
('19A47010051', '19A47010051', '0832d66ecf69f6e8ab90dd82eb0e6a9c0c9406f3', '2', 'Phạm Thị Thư', 'K28 TMĐT', 2, '2002-10-02', NULL, NULL),
('19A47010052', '19A47010052', '9e692a4dd3b9d92d022e7fb83470abb4ba21bc59', '2', 'Nguyễn Ngọc Lan', 'K28 TMĐT', 2, '2002-08-06', NULL, NULL),
('19A47010055', '19A47010055', '253c319d7ba5dc85a8f32851f1bd46aa0763e923', '2', 'Đào Thị Thu Hằng', 'K28 TMĐT', 2, '2002-05-09', NULL, NULL),
('19A47010057', '19A47010057', '4bc7a809725835652e27aaea949856f67e39860d', '2', 'Trần Thị Hương Giang', 'K28 TMĐT', 2, '2002-07-06', NULL, NULL),
('19A47010058', '19A47010058', 'a756828b7c86332df501c77dd6b5a1949e0a975d', '2', 'Vũ Thị Thanh Huyền', 'K28 TMĐT', 2, '2001-11-08', NULL, NULL),
('19A47010059', '19A47010059', 'aef8ba3d32311e4a93e7739552352416d30cbcae', '2', 'Phan Hải Long', 'K28 TMĐT', 1, '2001-12-06', NULL, NULL),
('19A47010060', '19A47010060', 'e60d2af3e962025537ea236845e0255c86ee31ff', '2', 'Nguyễn Tiến Đạt', 'K28 TMĐT', 1, '2003-01-08', NULL, NULL),
('19A47010063', '19A47010063', 'a4a7110cfc61920ff8d102e3d0ef5032be8087f3', '2', 'Lê Đặng Hải Anh', 'K28 TMĐT', 2, '2002-05-03', NULL, NULL),
('19A47010064', '19A47010064', 'e004c39f0a68b0e9dbab0db4e5cb17447f3c7c86', '2', 'Phí Thị Thanh Bình', 'K28 TMĐT', 2, '2003-02-04', NULL, NULL),
('19A47010065', '19A47010065', 'c6847f7338682882bcf701f50a07e6f53650b1da', '2', 'Nguyễn Phương Thảo', 'K28 TMĐT', 2, '2002-04-01', NULL, NULL),
('19A47010066', '19A47010066', '1c1c1eebdd1927eaa662dfe9aea19f5c217014d5', '2', 'Nguyễn Thị Huệ', 'K28 TMĐT', 2, '2001-02-12', NULL, NULL),
('19A47010067', '19A47010067', 'd9cbf9b085a3031708a88af8a2a429f0b2f974aa', '2', 'Võ Hoàng', 'K28 TMĐT', 1, '2001-05-08', NULL, NULL),
('19A47010069', '19A47010069', '3d5c6068f1ba488e04321a6f5c1b0e10d6e8d00e', '2', 'Nguyễn Thị Chanh', 'K28 TMĐT', 2, '2003-03-09', NULL, NULL),
('19A47010070', '19A47010070', 'a53d2d39a670d26a634dd1b22b6c78c5aba08771', '2', 'Dương Thị Khánh Linh', 'K28 TMĐT', 2, '2001-09-04', NULL, NULL),
('19A47010071', '19A47010071', '46acb73d623226c30fb5b2b96504ff5c3900de90', '2', 'Hoàng Thị Loan', 'K28 TMĐT', 2, '2002-12-08', NULL, NULL),
('19A47010072', '19A47010072', 'a68f46b1dd50d346c77ac7833f90b7e83348b82e', '2', 'Trần Văn Dũng', 'K28 TMĐT', 1, '2002-01-01', NULL, NULL),
('19A47010073', '19A47010073', 'c09ff09812d4b7cde76106d1349099e3d92466f8', '2', 'Đào Tuấn Tú', 'K28 TMĐT', 1, '2001-06-08', NULL, NULL),
('19A47010074', '19A47010074', '9f7deca8a74fdca32729d00ad3aca744335f8ab1', '2', 'Đoàn Thị Thim', 'K28 TMĐT', 2, '2001-07-08', NULL, NULL),
('19A47010075', '19A47010075', '804a420ef1c63e1255d72af8535da1c9eb871595', '2', 'Vũ Thị Lan Anh', 'K28 TMĐT', 2, '2002-05-01', NULL, NULL),
('19A47010076', '19A47010076', '588fe5d3320dc9c8377fe2fadbbb2672c53381c1', '2', 'PHẠM THỊ TRANG', 'K28 TMĐT', 2, '2003-02-03', NULL, NULL),
('19A47010077', '19A47010077', 'bb486851a6cfcbfdb2173f4e3e8850d5371d01e0', '2', 'Nguyễn Thị Hà', 'K28 TMĐT', 2, '2002-06-05', NULL, NULL),
...
CREATE TABLE IF NOT EXISTS `hs_tbl_thamgia` (
  `sMaDS` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `sMaCT` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `sMaTK` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
...
ALTER TABLE `hs_tbl_hososv`
  ...
  ADD KEY `FK_sMaHuyenTT` (`FK_sMaHuyenTT`),
  ADD KEY `FK_sMaXaTT` (`FK_sMaXaTT`),
  ADD KEY `FK_sMaTinhHT` (`FK_sMaTinhHT`),
  ADD KEY `FK_sMaHuyenHT` (`FK_sMaHuyenHT`),
  ADD KEY `FK_sMaXaHT` (`FK_sMaXaHT`),
...
--
ALTER TABLE `hs_dm_huyen`
  ADD CONSTRAINT `hs_dm_huyen_ibfk_1` FOREIGN KEY (`FK_sMaT`) REFERENCES `hs_dm_tinh` (`PK_sMaT`) ON UPDATE CASCADE;

--
-- Constraints for table `hs_dm_xa`
--
ALTER TABLE `hs_dm_xa`
  ADD CONSTRAINT `hs_dm_xa_ibfk_1` FOREIGN KEY (`FK_sMaH`) REFERENCES `hs_dm_huyen` (`PK_sMaH`) ON UPDATE CASCADE;

--
-- Constraints for table `hs_tbl_chuongtrinh`
--
ALTER TABLE `hs_tbl_chuongtrinh`
  ADD CONSTRAINT `hs_tbl_chuongtrinh_ibfk_1` FOREIGN KEY (`FK_sMaCB`) REFERENCES `hs_tbl_taikhoan` (`PK_sMaTK`) ON UPDATE CASCADE;

--
-- Constraints for table `hs_tbl_dangkydon`
--
ALTER TABLE `hs_tbl_dangkydon`
  ADD CONSTRAINT `hs_tbl_dangkydon_ibfk_1` FOREIGN KEY (`FK_sMaSV`) REFERENCES `hs_tbl_taikhoan` (`PK_sMaTK`) ON UPDATE CASCADE,
  ADD CONSTRAINT `hs_tbl_dangkydon_ibfk_2` FOREIGN KEY (`FK_sMaCanbo`) REFERENCES `hs_tbl_taikhoan` (`PK_sMaTK`) ON UPDATE CASCADE,
  ADD CONSTRAINT `hs_tbl_dangkydon_ibfk_3` FOREIGN KEY (`FK_sMaHanhChinh`) REFERENCES `hs_dm_hanhchinh` (`PK_sMaHanhChinh`) ON UPDATE CASCADE;

--
-- Constraints for table `hs_tbl_hososv`
--
ALTER TABLE `hs_tbl_hososv`
  ADD CONSTRAINT `hs_tbl_hososv_ibfk_1` FOREIGN KEY (`FK_sMaTK`) REFERENCES `hs_tbl_taikhoan` (`PK_sMaTK`) ON UPDATE CASCADE,
  ADD CONSTRAINT `hs_tbl_hososv_ibfk_2` FOREIGN KEY (`FK_sMaXaTT`) REFERENCES `hs_dm_xa` (`PK_sMaX`) ON UPDATE CASCADE,
  ADD CONSTRAINT `hs_tbl_hososv_ibfk_3` FOREIGN KEY (`FK_sMaXaHT`) REFERENCES `hs_dm_xa` (`PK_sMaX`) ON UPDATE CASCADE,
  ADD CONSTRAINT `hs_tbl_hososv_ibfk_4` FOREIGN KEY (`FK_sMaHuyenTT`) REFERENCES `hs_dm_huyen` (`PK_sMaH`) ON UPDATE CASCADE,
  ADD CONSTRAINT `hs_tbl_hososv_ibfk_5` FOREIGN KEY (`FK_sMaHuyenHT`) REFERENCES `hs_dm_huyen` (`PK_sMaH`) ON UPDATE CASCADE,
  ADD CONSTRAINT `hs_tbl_hososv_ibfk_6` FOREIGN KEY (`FK_sUuTien`) REFERENCES `hs_dm_uutien` (`PK_sMaNhom`) ON UPDATE CASCADE,
  ADD CONSTRAINT `hs_tbl_hososv_ibfk_7` FOREIGN KEY (`FK_sMaTinhHT`) REFERENCES `hs_dm_tinh` (`PK_sMaT`) ON UPDATE CASCADE,
  ADD CONSTRAINT `hs_tbl_hososv_ibfk_8` FOREIGN KEY (`FK_sMaTinhTT`) REFERENCES `hs_dm_tinh` (`PK_sMaT`) ON UPDATE CASCADE;
